...
<head>
    ...
    <title>EXTRUTURA | Dashboard</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/')}}" class="logo">
            ...
            <span class="logo-lg">E<b>X</b>TRUTURA</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="#">EXTRUTURA - SISTEMA DE ORÇAMENTO </a>.</strong> All rights
        reserved.
    </footer>
